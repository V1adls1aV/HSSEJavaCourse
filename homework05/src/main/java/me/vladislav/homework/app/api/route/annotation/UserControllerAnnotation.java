...
public interface UserControllerAnnotation {
  ...
  ResponseEntity<Long> createUser(
      @Parameter(description = "User's profile data") @Valid @RequestBody
      UserCreateRequest request) throws ExecutionException, InterruptedException;
  ...
  ResponseEntity<UserGetResponse> getUser(@PathVariable Long userId) throws ExecutionException, InterruptedException;
}
