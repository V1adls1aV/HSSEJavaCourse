...
public class EndToEndTest {
  ...
  public void testFullUserFlow() {
    ...
    assertTrue(restTemplate.postForEntity("/api/user/" + userId + "/book", book1, BookGetResponse.class).getStatusCode().is2xxSuccessful());
    assertTrue(restTemplate.postForEntity("/api/user/" + userId + "/book", book2, BookGetResponse.class).getStatusCode().is2xxSuccessful());
    ...
    assertTrue(restTemplate.postForEntity("/api/user/" + userId + "/course", course1, CourseGetResponse.class).getStatusCode().is2xxSuccessful());
    assertTrue(restTemplate.postForEntity("/api/user/" + userId + "/course", course2, CourseGetResponse.class).getStatusCode().is2xxSuccessful());
    ...
    assertTrue(restTemplate.postForEntity("/api/user/" + userId + "/university", uni1, UniversityGetResponse.class).getStatusCode().is2xxSuccessful());
    assertTrue(restTemplate.postForEntity("/api/user/" + userId + "/university", uni2, UniversityGetResponse.class).getStatusCode().is2xxSuccessful());
